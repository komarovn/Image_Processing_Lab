...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// 
			this->ìåòîäûToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {this->áèíîğèçàöèÿToolStripMenuItem, 
			...
			this->áèíîğèçàöèÿToolStripMenuItem->Text = L"Binarization";
			// 
